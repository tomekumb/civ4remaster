...
void CvGameTextMgr::parsePromotionHelp(CvWStringBuffer &szBuffer, PromotionTypes ePromotion, const wchar* pcNewline)
{
	...
	// <trs.promoleads>
	if (getBugOptionBOOL("Taurus__PromotionLeadsTo"))
		parsePromotionLeadsToHelp(szBuffer, ePromotion, pcNewline);
	// </trs.promoleads>
}

// trs.promoleads (fromAdvCiv):
void CvGameTextMgr::parsePromotionLeadsToHelp(CvWStringBuffer &szBuffer, PromotionTypes ePromotion, const wchar* pcNewline)
{
